...
\begin{frame}{Machine Learning for Multiclass Classification}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node [rounded corners, above =(0.2cm) of a] {\alert{$x$}};


      \visible{
      \node(gal){\includegraphics[width=1.5cm]{galaxy}};
      \node [rounded corners, above =(0.2cm) of gal] {\alert{${\theta}$}};
...
\visible{
  ...
  \node [rounded corners, above = (0.2cm) of b] {\alert{$y$}};
...
%   \begin{center}
%     \begin{tikzpicture}
%       \node{\includegraphics[width=1.5cm]{galaxy}};
...
\node(a){\includegraphics[width=1.5cm]{galaxy}};
