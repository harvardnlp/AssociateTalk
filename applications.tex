...
\begin{frame}{Translation Performance}
  ...
  \begin{center}
     \includegraphics[width=10cm]{wmt}
  \end{center}
\end{frame}
...
\begin{frame}{Summarization}
  ...
  \begin{center}
    \includegraphics[trim={1cm 0cm 0cm 0cm}, clip, width=7cm]{ap}
  \end{center}
...
\begin{frame}{Sentence Summarization Progress}

  \begin{center}
    \includegraphics[height=0.6\textheight]{Gigaword}
  \end{center}
