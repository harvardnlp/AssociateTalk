...
\begin{frame}{Talk about Text (Summary) }
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node (gal) {\includegraphics[width=2cm]{galaxy}};
      ...
      \visible<2>{
        \node(b) [xshift=4.5cm, yshift=-1cm, rectangle, scale=0.8, draw,thick,fill=blue!0,text width=12em, rounded corners, inner sep =5pt, minimum height=1em]{\baselineskip=50pt \footnotesize 
...
\begin{frame}{Talk about Text (Summary) }
  \begin{center}
    \begin{tikzpicture}
      ...
      \node{\includegraphics[width=2cm]{galaxy}};
...
\end{tabular}
  \end{figure}  
  \begin{center}
    \includegraphics[width=10cm]{E2EChallenge}
  \end{center}
\end{frame}
...
\node(a){\includegraphics[width=2cm]{galaxy}};
