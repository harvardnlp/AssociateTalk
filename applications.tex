...
\node[rectangle, xshift=-5cm, scale=0.8, draw,thick,fill=blue!0,text width=16em, rounded corners, inner sep =5pt, minimum height=1em] {
\small
...
\node[xshift=-5cm, draw, scale=0.5, inner sep=10pt, rounded corners, text width=30em, xshift=-7.5cm,]{
\small
  \begin{center}
...
\node{\includegraphics[width=5cm]{galaxy}};
\path<2>[draw] (0, 0) --  (2,0) ;
 \node [xshift=-4cm, rectangle, thick,fill=blue!0,text width=5cm, rounded corners, inner sep =5pt, minimum height=1em]{\baselineskip=50pt \includegraphics{latexin}};
\visible<2>{
\node [xshift=3.5cm, rectangle, scale=0.6, draw,thick,fill=blue!0,text width=24em, rounded corners, inner sep =5pt, minimum height=1em]{\baselineskip=50pt \footnotesize 
\sTWO
};}
